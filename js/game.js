...
(function () {
  ...
  const I18N = {
    fr: {
      ...
      installIos: "Sur iPhone : appuie sur le bouton Partager en bas de Safari, puis sur « Sur l'écran d'accueil ». GéoQuiz s'ajoutera comme une vraie application, jouable hors connexion.",
      boardTitle: "🏆 Classement",
      boardAsk: "Sous quel nom veux-tu entrer au classement ?",
      boardSubmit: "M'inscrire",
      boardSending: "Envoi…",
      boardFailed: "Classement injoignable — score gardé en local.",
      boardEmpty: "Personne ici pour l'instant : la place est à prendre !",
      boardRank: "{medal} {rank} sur {total} — bravo {pseudo} !",
      boardUnranked: "{pseudo}, il te faut mieux pour entrer dans le top {n}.",
      boardChange: "changer de nom",
      boardYou: "toi",
      continents: {
    ...
    en: {
      ...
      installIos: "On iPhone: tap the Share button at the bottom of Safari, then “Add to Home Screen”. GéoQuiz will be added like a real app, playable offline.",
      boardTitle: "🏆 Leaderboard",
      boardAsk: "What name should we put on the board?",
      boardSubmit: "Sign me up",
      boardSending: "Sending…",
      boardFailed: "Leaderboard unreachable — score kept locally.",
      boardEmpty: "Nobody here yet: the top spot is up for grabs!",
      boardRank: "{medal} {rank} of {total} — well played {pseudo}!",
      boardUnranked: "{pseudo}, you'll need more to crack the top {n}.",
      boardChange: "change name",
      boardYou: "you",
      continents: {
