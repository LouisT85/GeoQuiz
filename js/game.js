...
(function () {
  ...
  const MODES = {
    ...
    saisie: { icon: "✍️", stages: ["type"], needsGeo: false, usesMap: false },
  ...
  const I18N = {
    fr: {
      ...
      modes: {
        ...
        saisie: { label: "Drapeaux (libre)", desc: "Un drapeau s'affiche : écris le nom du pays." },
    ...
    en: {
      ...
      modes: {
        ...
        saisie: { label: "Flags (free)", desc: "A flag appears: type the country's name." },
